$(document).ready(function(){
    ...
    $("#cashRecords").click(function(){
        window.location.href='/html/bms/BMSPayBalance.html?accountId='+accountId+'&accountType='+accountType1+'&status=1';
    });
    //现金结算待结算记录
    $("#cashUnRecords").click(function(){
        window.location.href='/html/bms/BMSPayBalance.html?accountId='+accountId+'&accountType='+accountType1+'&status=0';
    });
    //积分中心结算收支明细
    $("#integralRecords").click(function(){
        window.location.href='/html/bms/BMSPayBalance.html?accountId='+accountId+'&accountType='+accountType2+'&status=1';
    });
    //积分中心结算待结算记录
    $("#integralUnRecords").click(function(){
        window.location.href='/html/bms/BMSPayBalance.html?accountId='+accountId+'&accountType='+accountType2+'&status=0';
    });


    //充值提现记录,页面a链接
    $(".rechargeCash .aBtn,#cashRechargew,#integralRechargew").click(function(){
        window.location.href='/html/bms/BMSRechargeDraw.html?accountId='+accountId;
    });
    ...
    if(timeNow>=2016){
        ...
        $("#cashYear").click(function(){
            if(undefined!=$(this).val() && ""!=$(this).val()){
                window.location.href='/html/bms/BMSPayBalance.html?accountId='+accountId+'&accountType='+accountType1+'&status=-1'+'&years='+$(this).val();
            }
        });
        $("#integralYear").click(function(){
            if(undefined!=$(this).val() && ""!=$(this).val()){
                window.location.href='/html/bms/BMSPayBalance.html?accountId='+accountId+'&accountType='+accountType2+'&status=-1'+'&years='+$(this).val();
            }
        });
    }else {
        $(".theYear").hide();
