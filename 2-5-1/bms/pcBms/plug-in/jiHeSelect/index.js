...
var jiHeSelect={
 ...
 $('head').append(' <link rel="stylesheet" href="http://at.alicdn.com/t/font_hf4vfvktlbp7rpb9.css"/>');
...
function addSelect(id,array,bacKFn){
      ...
      $('#'+id).append('<span class="iconfont icon-shangxia-copy"></span>');
      ...
      if($('#'+selectId).length){
        ...
        div.children('p').css({
          ...
          _this.append('<span class="iconfont icon-shangxia-copy"></span>');
          // $('.iconfont').css('font-size', '12px');
