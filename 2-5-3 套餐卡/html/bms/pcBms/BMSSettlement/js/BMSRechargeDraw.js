...
$(document).ready(function() {
    ...
    //充值提现记录删除，数据请求
    $("body").on("click","#tableCon .delete",function(){
        ...
        $.ajax({
            ...
            success:function(res) {
                $("#tableCon .delete#"+id).parents("tr").remove();
            }
        });
    });
});
    ...
    $.ajax({
        ...
        success:function(res){
            ...
            if(res.sc=="0"){
                ...
                var tbodyHtml="<thead><tr><th>申请时间</th><th>充值/提现银行帐号|流水号</th><th>账户类型</th><th>充值金额(元)</th><th>提现金额(元)</th><th>申请人</th><th>状态</th><th>处理完成时间</th><th>备注</th><th>操作</th></tr></thead><tbody>";
