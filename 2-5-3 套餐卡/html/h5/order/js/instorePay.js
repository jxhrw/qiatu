            ...
            if ("1" == memberFlag) {
                ...
                $(".enterAmount input").on('blur', function () {//监听输入框内容的变化     
                    if (0 == $(".enterAmount input").val().length) {
                        ...
                        amount = Math.round($(".enterAmount input").val() * 100);
                                    ...
                                    if (undefined != data.data.membershipCardInfo) {//会员卡展示
                                        ...
                                        $.each(cardInfo, function (i) {
                                            var rejectCouponCodes = cardInfo[i].rejectCouponCodes,//互斥的券
                                                ...
                                                costAmount = cardInfo[i].paidFaceValue,
                                                cardNeedInfo = {};
                ...
                $(".pointsSwitch").click(function () {
                    if ($(this).hasClass("on")) {
                        $(".submit span").html("&yen;" + (Math.round($(".submit span").html().slice(1) * 100) + (parseInt($(".pointsSwitch").attr("value")))) / 100);
                        $(this).removeClass("on");
                    } else {
                        $(".submit span").html("&yen;" + (Math.round($(".submit span").html().slice(1) * 100) - (parseInt($(".pointsSwitch").attr("value")))) / 100);
