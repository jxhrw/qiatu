...
$(document).ready(function () {
    ...
    $.ajax({ //商户详情接口
        ...
        success: function (data) {
            ...
            var payUrl = payUrl = "../../order/instorePay.html?member_hotelid=" + id + "&productId=" + productId + "&storeName=" + hotelName; //店内支付地址
            $("title").html(groupName + "会员中心");
            $(".pay").click(function () {
                window.location.href = payUrl;
            });
            $(".orders").click(function () {
                window.location.href = "../../order/myOrderList.html?hotelid=" + id;
            });
            ...
            $(".book").click(function () {
                if (1 == hotelIds.length) {
                    window.location.href = "../../product/detail/bnbShare.html?id=" + hotelIds[0];
                } else {
                    window.location.href = "../../product/list/exchangeList.html?hotelIds=" + hotelIds.join(",") + "&button=0";
                }
            });
            $(".checkmore").attr("href", "../../member/giftcard/memberships.html?hotelIds=" + encodeURIComponent(hotelIds.join(",")));
...
function getDetail(dom, arr, Lstate) {
    $(dom).click(function (e) {
        ...
        window.location.href = "../../member/giftcard/cardOrCoupons.html?couponCode=" + arr[domIndex] + "&lstate=" + Lstate;
    })
}
//获取url的参数
function getRequest() {
            ...
            success: function (data) {
                ...
                if (undefined != data.data) {
                    $.each(data.data, function (i) {
                        ...
                        var redeemUrl = "../../member/giftcard/redeem.html?code=" + couponCode + "&num=" + usableRemain / 100 + "&name=" + couponName + "&ratio=" + ratio + "&PointsDeadline=" + exchangePointsDeadline;
