...
var ajaxUrlAll={
    "cardList":"/coupon/h5/cardList",//会员卡列表
    "couponList":"/coupon/h5/couponList",//券列表
    "couponCardDetail":'/coupon/h5/info',//卡券详情
    "couponCardRemove":'/coupon/h5/remove',//卡券移除
    "comboList":"/coupon/h5/comboList",//套餐卡列表
    "comboInfo":"/coupon/h5/comboInfo", //套餐卡子资产列表
    "unNormalList":"/coupon/h5/unNormalList", //卡券作废列表
    "activateCard": "/coupon/h5/member/activateCard" //套餐卡激活接口
};
...
//列表页背景图-小版
function hasBackground_min(reminder,top){
    var html='<div id="hasBackground"><div style="text-align:center;margin: 0 auto;margin-top:'+top+';background:url(/html/h5/publicFile/images/none.png) no-repeat center top/contain;height: 6rem;width: 6rem;overflow: hidden;border-radius: 50%;-moz-border-radius: 50%;-webkit-border-radius: 50%;"></div><p style="text-align: center;margin-top: 1.3rem;color: #444;font-size: 0.833rem;">'+reminder+'</p></div>';
    return html;
}
