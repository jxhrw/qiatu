$(document).ready(function(){
    ...
    function navHeader(){
        ...
        $(".navigation").css({'padding':'0 4%','clear':'both','overflow':'hidden','height':'3rem','background':'#fff','font-size':'0.8rem','color':'#484848','position':'fixed','top':'0','width':'92%','z-index':'9999'});
        ...
        $("#navSearch").click(function(){
            window.location.href = window.location.pathname.split("/html")[0]+'/html/h5/product/list/findMinsu.html';
        });
    }
