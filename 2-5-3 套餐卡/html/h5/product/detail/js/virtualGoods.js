                                ...
                                if(res.sc=="0"){
                                    if(undefined!=res.data && res.data.length>0){
                                        ...
                                        $(".notPayLook").click(function(){
                                            window.location.href="../../order/orderDetailN.html?orderid="+res.data[0].orderid;
                                        });
                                    }
                                    else {
                                        payment();
                    ...
                    $.post(memberUrl,{data:JSON.stringify(dataN)},function(data){
                        ...
                        if(data.sc=="0"){
                            ...
                            if(isApp==undefined){
                                ...
                                location.href="/user/h5/mbcenter?regsucc_tourl="+encodeURIComponent(urlLocation);
                                return;
                            }
                            if(isApp=="jiheios"){
                                data1='{"act":"toLogin"}';
                        ...
                        if(isApp==undefined){//微信端
                            $.post("/product/h5/stock/judge",{data:JSON.stringify(dataN)},function(res){
                                ...
                                if(res.sc==0){
                                    ...
                                    console.log(data);
                                    var b='', c='', d='', e='', f='';
                                    if(GetParams().needpoints){
                                        b="&needpoints="+GetParams().needpoints;
                                    }
                                    if(assetType){
                                    ...
                                    window.location.href='../../order/toOrder.html?id='+data.productid+b+c+d+e+f;
                                }
