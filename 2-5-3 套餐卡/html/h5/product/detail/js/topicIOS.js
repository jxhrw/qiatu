...
if(isAndroid) {
    //setTimeout("var url, andrData;var device = new Device();device.requestCommit(\'/content/client/topic/detail\',\"{\'id\':\'\"+id+\"\'}\");",200);
    var url, andrData;
    var device = new Device();
    device.requestCommit('/content/client/topic/detail', "{'id':'"+id+"'}");
