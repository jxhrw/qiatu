...
$(document).ready(function () {
    ...
    sortField ? sort.field = sortField : null;
    sortRule ? sort.rule = sortRule : null;
    cities ? reqData.cities = cities.split(',') : null;//支持城市筛选
    ltporatio ? reqData.ltporatio = ltporatio : null;
    checkin ? reqData.checkin = checkin : null;
    tags ? reqData.tags = tags.split(',') : null;//支持标签筛选
    sortArr.push(sort);
    isEmptyObject(sort)?null:reqData.sorts=sortArr;
    console.log(reqData);
    getList(reqData, 5, 1);
