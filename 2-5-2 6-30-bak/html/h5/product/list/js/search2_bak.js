...
$(document).ready(function() {
	...
	var pagecnt=5;
	var keyWords=getRequest().keyWords;
	...
	dataPost.exchFlag=withOrWithout(getParams.ef);
	dataPost.ltporatio=withOrWithout(getParams.lto);
	dataPost.checkin=withOrWithout(getParams.ckn);
	dataPost.assetType=withOrWithout(getParams.assetType);
	dataPost.priceType=withOrWithout(getParams.priceType);

	dataPost.productIds=withOrWithoutList(getParams.ids);
	dataPost.hotelIds=withOrWithoutList(getParams.hids);
	dataPost.objectTypes=withOrWithoutList(getParams.ots);
	dataPost.hotelTypes=withOrWithoutList(getParams.hts);
	dataPost.coopTypes=withOrWithoutList(getParams.ts);
	dataPost.cities=withOrWithoutList(getParams.cities);
	...
	var parameter={
		...
		classId:".searchwrap",
		lengthClassId:".wrap",
		leaveState:"staticweixinMinSuLeave"+encodeURIComponent(decodeURIComponent(search)),
		pageNum:"staticweixinMinSuPage"+encodeURIComponent(decodeURIComponent(search)),
		originalHtml:"staticweixinMinSuHtml"+encodeURIComponent(decodeURIComponent(search)),
		originalScrollTop:"staticweixinMinSuScrollTop"+encodeURIComponent(decodeURIComponent(search)),
		originalRequestRata:"staticweixinMinSuAjaxData"+encodeURIComponent(decodeURIComponent(search)),
	...
	$(".screen td").click(function(){
		...
		//var paramPage = {"pagecnt":"5","pageno":c,"keyWords":keyWords,"tags":search};
		dataPost.pageno=c;
		dataPost.sorts=sortKind;
		ajaxRequest(url,dataPost);
	});

	$(".picImg,.proImg,.tag span,.proComment,.topic").live("click", function () {
