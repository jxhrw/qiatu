...
//酒店结构
var hotelContent = "<a class=\"hotelh5url\" href=\"#\"><img class=\"listImage\" src=\"\" /></a><img class=\"tips\" src=\"../detail/images/酒店.png\" /><a class=\"brandh5url\" href=\"#\"><img class=\"brand\" src=\"\"></a><span class=\"plusPrice no\"></span><p class='price otherPrice'>￥<strong></strong></p><p class=\"distant\"> </p><p class=\"hotelName name\"></p><div class=\"introHotel\"><p></p><div class=\"tag\" style='padding: 1rem 0 0 0;'></div></div>"
//优惠结构
                ...
                for(var i=0;i<data.data.topicList.length;i++){
                    ...
                    if(data.data.topicList[i].objectType == 1){
						...
						$(".tag span").click(function(event) {
							var ee=$(this).html();
							window.location.href="/html/h5/product/list/list2.html?tags="+ee
						});
                        }
                        else{
	                        ...
	                        $("div.list:last").find(".listImage").attr("src",""+data.data.topicList[i].imageUrl);
	                        $("div.list:last").find(".brand").attr("src",""+data.data.topicList[i].brandIcon);
	                        if(!data.data.topicList[i].price || data.data.topicList[i].price == -1){
                            ...
                            $("div.list:last").find(".tips").remove();
