    ...
    $("body").on("click",".bian_btn",function (e) {
    	...
    	if (couponid == undefined){
    		...
    		if ($(".new-btn").children().attr("coupontype") == "5") {
	             window.location.href = "/html/bms/pcBms/setCoupons/createCoupon.html?couponType=5&couponId=" + couponid;
	    	} else if ($(".new-btn").children().attr("coupontype") == "1") {
	             window.location.href = "/html/bms/pcBms/setCoupons/createCoupon.html?couponType=1&couponId=" + couponid;
	    	} else {
	             window.location.href = "/html/bms/pcBms/setCoupons/createCoupon.html?couponType=2&couponId=" + couponid;
	    	}
    	}
    })
//-----------------------
...
//新建卷
    $(".new-btn").children().click(function () {
    	if ($(".new-btn").children().attr("coupontype") == "5") {
             window.location.href = "/html/bms/pcBms/setCoupons/createCoupon.html?couponType=5";
             console.log(window.location.href);
    	} else if ($(".new-btn").children().attr("coupontype") == "1") {
             window.location.href = "/html/bms/pcBms/setCoupons/createCoupon.html?couponType=1";
    	} else {
             window.location.href = "/html/bms/pcBms/setCoupons/createCoupon.html?couponType=2";
    	}
    })
