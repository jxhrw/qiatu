...
$(document).ready(function() {
    ...
    $(".cashAccount").click(function () {//现金账户
        window.location.href= "/html/h5/member/account/cashAccount.html";
    });
    ...
    $(".myCoupon").click(function () {//我的礼券
        window.location.href="/html/h5/member/giftcard/memberships.html?member_hotelid=";
    });
    $(".orderList").click(function () {//我的订单
        window.location.href="/html/h5/order/myOrderList.html?member_hotelid=";
    });
    $(".exchange").click(function () {//积分兑换
        window.location.href="/html/h5/member/exchange.html?member_hotelid=";
    });
    $(".integralMall").click(function () {//积分商城
        window.location.href="/html/h5/product/list/integralMall.html?tags=%E7%A7%AF%E5%88%86%E5%95%86%E5%9F%8E&assetType=3&priceType=1";
    });
    $(".earnPoints").click(function () {//赚取积分
        window.location.href="/html/h5/member/other/earnPointsNoteWei.html";
    });
    $(".trends").click(function () {//积分动态
        window.location.href="/html/h5/member/other/consumingRecords.html?member_hotelid=";
    });
    $(".vip").click(function () {//会员礼遇
        window.location.href="/html/h5/member/other/memberVIP.html?member_hotelid=";
    });
    $(".myInfo").click(function () {//个人信息
        window.location.href="/html/h5/member/personinfo/myInfo.html?member_hotelid=";
    });
    $(".faq").click(function () {//常见问题
        window.location.href="/html/h5/member/other/FAQ.html?member_hotelid=";
    });
                    ...
                    $.post('/coupon/h5/member/undelivered',{data:JSON.stringify(couponDate)},function(res){
                        if(res.sc==0){
                            ...
                            if(undefined!=res.assetsList && 0<res.assetsList.length){
                                $(".rights").html(liHtml);
                                $(".goReceive").attr("href","/html/member/personinfo/memRights.html?name="+data.data.realname);
                                $(".modal").hide();
                                $(".receiveBox").show();
                            }
                        }
            ...
            if(data.sc==0){
                ...
                $(".in-store").click(function () {
                    if(data.data.hotelBaseInfo.type!="0"){
                        window.location.href="/html/h5/product/detail/bnbShare.html?id="+hotelId;
                    }else {
                        window.location.href="/html/h5/product/detail/hotelShare.html?id="+hotelId;
                    }
                });
                var payUrl="/html/h5/order/instorePay.html?member_hotelid="+hotelId+"&productId="+productId+"&storeName="+hotelName;
