$(document).ready(function(){
    ...
    $(".bottom").click(function(){
        window.location.href="/html/h5/order/payChannels.html?orderid="+GetParams().orderid+"&data="+productId;
    });
            ...
            if (data.sc == "0") {
                if(ua.match(/MicroMessenger/i) != 'micromessenger' && /(iPhone|iPad|iPod|iOS)/i.test(navigator.userAgent) && /jihe/i.test(navigator.userAgent)){
                    ...
                    if(data.data.memberFlag=="0"){
                        window.location.href="/html/h5/login/attention.html?refered=consumption";
                    }
                    else {
                        window.location.href="/html/h5/member/giftcard/memberships.html";
                    }
                }
            }
